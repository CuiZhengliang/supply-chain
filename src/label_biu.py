...
if __name__ == '__main__':
    for i in range(6):
        LabelDataPath = r'E:\PycharmProjects\supply-chain\LabelSets\labelset' + str(i + 1) + '.csv'
        ...
        writepath = r'E:\PycharmProjects\supply-chain\LabelSets\label' + str(i + 1) + '.csv'
        df.to_csv(writepath, index=False)

    df = pd.read_csv(r'E:\PycharmProjects\supply-chain\dataset\goodsalePlus.csv')
    ...
    df.to_csv(r'E:\PycharmProjects\supply-chain\output\Last.csv', index=False)
