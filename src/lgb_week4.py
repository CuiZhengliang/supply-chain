...
#
#     print('调参1：提高准确率')
#     for num_leaves in range(25, 60, 2):
...
#     # for max_bin in range(25,255,5):
#     for min_data_in_leaf in range(10, 50, 2):
...
# result.to_csv(r'E:\PycharmProjects\supply-chain\params\result_params_week4.csv', index=False)
    ...
    #
    # val[['sku_id', 'week4', 'pre']].to_csv(r'E:\PycharmProjects\supply-chain\var_test\val_week4.csv', index=False)
    # online_test[['sku_id', 'week4', 'pre']].to_csv(r'E:\PycharmProjects\supply-chain\var_test\online_week4.csv', index=False)
    ...
    test['week4'] = pd.Series(preds_test)
    test[['sku_id', 'week4']].to_csv(r'E:\PycharmProjects\supply-chain\lgb_results\weekPlus4.csv', index=False)
