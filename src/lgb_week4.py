...
# result.to_csv(r'E:\PycharmProjects\Task2Plus\params\result_params_week4.csv', index=False)
    ...
    #
    # val[['sku_id', 'week4', 'pre']].to_csv(r'E:\PycharmProjects\Task2Plus\var_test\val_week4.csv', index=False)
    # online_test[['sku_id', 'week4', 'pre']].to_csv(r'E:\PycharmProjects\Task2Plus\var_test\online_week4.csv', index=False)
