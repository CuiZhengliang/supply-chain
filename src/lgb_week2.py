...
if __name__ == '__main__':
    ...
    #
    # # print('log_loss',metrics.mean_squared_error(offline_test['week2'],offline_test['pre'])** 0.5)
    #
    # # print('线上预测')
    ...
    test['week2'] = pd.Series(preds_test)
    test[['sku_id', 'week2']].to_csv(r'E:\PycharmProjects\supply-chain\lgb_results\weekPlus2.csv', index=False)
