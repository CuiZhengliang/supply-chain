...
# result.to_csv(r'E:\PycharmProjects\supply-chain\params\result_params_week5.csv', index=False)
    ...
    #
    # val[['sku_id', 'week5', 'pre']].to_csv(r'E:\PycharmProjects\supply-chain\var_test\val_week5.csv', index=False)
