...
#
#     print('调参1：提高准确率')
#     for num_leaves in range(10, 40, 2):
...
#     for min_data_in_leaf in range(10,40, 2):
...
# result.to_csv(r'E:\PycharmProjects\Task2Plus\params\result_params_week5.csv', index=False)
    ...
    #
    # val[['sku_id', 'week5', 'pre']].to_csv(r'E:\PycharmProjects\Task2Plus\var_test\val_week5.csv', index=False)
    # online_test[['sku_id', 'week5', 'pre']].to_csv(r'E:\PycharmProjects\Task2Plus\var_test\online_week5.csv', index=False)
    #
