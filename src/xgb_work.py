...
if __name__ == '__main__':
    ...
    model = xgb.train(params,DataSet,num_boost_round=1000,evals=watchlist)
    ...
    watchlist = [(DataSet,'train')]
    model = xgb.train(params,DataSet,num_boost_round=1500,evals=watchlist)
    y_pred = model.predict(dataset3)
